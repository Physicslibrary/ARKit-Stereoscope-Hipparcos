...
For example, HID 71683 is named "Rigel Kentaurus A" and it is 1.34 parsec (Distance). Rigel Kentaurus A is part of a triple star system called Alpha Centauri that is the nearest star system to the Sun.
