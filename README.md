...
For example, HID 71683 has a name "Rigel Kentaurus A" and a distance 1.34 parsec. Rigel Kentaurus A is part of a triple star system called Alpha Centauri. Alpha Centauri is the nearest star system to the Sun.
